...
$query = "SELECT * FROM calc_sucursales";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar-params" class="">
                        ...
                        <div id="buttons">
                            <a href="sucursales_precio_ruta_add.php">
    ...
    $(document).ready(function() {
        ...
        function livesearch() {
            $(document).on("keyup", "#busc_cliente", function() {
                ...
                var action = "search_sucursal_precio";
        ...
        function load_list(page) {
            var action = "fetch_sucursales_precios";
            $.ajax({
                url: "php/action.php",
                type: "POST",
                data: {
