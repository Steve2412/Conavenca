                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <select class="form-control" placeholder="Origen" name="origen" id="origen">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <select class="form-control" placeholder="Destino" name="destino" id="destino">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                ...
                                                <a id="add_ruta" name="add_ruta" class="btn btn-primary px-4">Agregar ruta</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            if (origen != '' && destino != '' && precio != '') {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "Ya existe la ruta") {
                            alert("Ya existe la ruta");
                            return;
                        }
                        alert("Ruta agregada")
